...
\define('_AM_WGSLIDER_IMAGE_DESCRIPTION', 'Beschreibung');
...
\define('_AM_WGSLIDER_SLIDESHOW_DESCR_SWIPER', 'Swiper Slideshow ohne zusätzliche Anforderungen');
\define('_AM_WGSLIDER_SLIDESHOW_DESCR_SPLIDE', 'Splide Slideshow ohne zusätzliche Anforderungen');
...
\define('_AM_WGSLIDER_SLIDESHOW_DELAY', 'Verzögerung');
\define('_AM_WGSLIDER_SLIDESHOW_PAUSE', 'Pause bei Mouse-over');
\define('_AM_WGSLIDER_SLIDESHOW_WRAP', 'Slideshow soll permanent laufen');
\define('_AM_WGSLIDER_SLIDESHOW_KEYBOARD', 'Unterstützung Tastatur');
\define('_AM_WGSLIDER_SLIDESHOW_TOUCH', 'Unterstützung Touch');
\define('_AM_WGSLIDER_SLIDESHOW_SHOW_INDICATOR', 'Indikator Unterstützung');
\define('_AM_WGSLIDER_SLIDESHOW_SHOW_PREV_NEXT', 'Vorheriges/nächstes anzeigen');
\define('_AM_WGSLIDER_SLIDESHOW_SHOW_CAPTION', 'Titel Unterstützung');
\define('_AM_WGSLIDER_SLIDESHOW_SHOW_DESCR', 'Beschreibung Unterstützung');
\define('_AM_WGSLIDER_SLIDESHOW_SHOW_THUMBS', 'Vorschaubilder anzeigen');
\define('_AM_WGSLIDER_SLIDESHOW_FULLSIZE', 'Volle Größe');
\define('_AM_WGSLIDER_SLIDESHOW_PERVIEW', 'Bilder pro Ansicht');
\define('_AM_WGSLIDER_SLIDESHOW_AUTOPLAY', 'Automatisch starten');
\define('_AM_WGSLIDER_SLIDESHOW_EFFECT', 'Effekt');
\define('_AM_WGSLIDER_SLIDESHOW_BG_CAPTION', 'Hintergrund Titel');
...
\define('_AM_WGSLIDER_PERMS_GLOBAL_SUBMIT', 'Globale Berechtigung zum Erstellen und Bearbeiten aller');
\define('_AM_WGSLIDER_PERMS_GLOBAL_SUBMIT_DESC', 'Gruppen, die Berechtigung haben sollen, um <ul><li>Kategorien zu erstellen</li><li>alle Kategorien zu bearbeiten</li><li>Bilder in alle Kategorien hochzuladen</li></ul>');
\define('_AM_WGSLIDER_PERMS_GLOBAL_VIEW', 'Berechtigung zum Anzeigen aller Kategorien');
\define('_AM_WGSLIDER_PERMS_GLOBAL_VIEW_DESC', 'Gruppen, die Berechtigung haben sollen, alle Kategorien anzuzeigen');
\define('_AM_WGSLIDER_PERMS_CATEGORY_SUBMIT', 'Berechtigung zum Erstellen und Bearbeiten eigener Kategorien');
\define('_AM_WGSLIDER_PERMS_CATEGORY_SUBMIT_DESC', 'Gruppen, die Berechtigung haben sollen, um <ul><li>Kategorien zu erstellen</li><li>nur eigene Kategorien zu bearbeiten</li><li>Bilder nur in eigene Kategorien hochzuladen</li></ul>');
\define('_AM_WGSLIDER_PERMS_GLOBAL_DESC', '<ul>
                                                ...
                                                <li>' . \_AM_WGSLIDER_PERMS_CATEGORY_SUBMIT . ': ' . \_AM_WGSLIDER_PERMS_CATEGORY_SUBMIT_DESC . '<br></li>
                                           </ul>');
\define('_AM_WGSLIDER_PERMS_CATEGORY_VIEW', 'Berechtigung zum Anzeigen dieser Kategorie');
\define('_AM_WGSLIDER_PERMS_CATEGORY_VIEW_DESC', 'Gruppen, die Berechtigung haben sollen, diese Kategorie anzuzeigen');
