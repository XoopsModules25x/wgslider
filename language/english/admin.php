...
\define('_AM_WGSLIDER_IMAGE_SUBMITTER', 'Submitter');
// Slideshow misc
...
\define('_AM_WGSLIDER_SLIDESHOW_RESET_ERROR', 'An error occured during reset of slideshows');
// Slideshow add/edit
...
\define('_AM_WGSLIDER_CLONE_CONGRAT', 'Congratulations! %s was sucessfully created!<br>You may want to make changes in language files.');
...
\define('_AM_WGSLIDER_CLONE_FAIL', 'Sorry, we failed in creating the new clone. Maybe you need to temporally set write permissions (CHMOD 777) to modules folder and try again.');
// Image editor
