...
\define('_AM_WGSLIDER_PERMS_GLOBAL_SUBMIT', 'Permission global to submit and edit all');
\define('_AM_WGSLIDER_PERMS_GLOBAL_SUBMIT_DESC', 'Groups which should have permission to <ul><li>create categories</li><li>edit all categories</li><li>upload images to all categories</li></ul>');
\define('_AM_WGSLIDER_PERMS_GLOBAL_VIEW', 'Permission global to view all');
\define('_AM_WGSLIDER_PERMS_GLOBAL_VIEW_DESC', 'Groups which should have permission to view all categories');
\define('_AM_WGSLIDER_PERMS_CATEGORY_SUBMIT', 'Permission to submit and edit own categories');
\define('_AM_WGSLIDER_PERMS_CATEGORY_SUBMIT_DESC', 'Groups which should have permission to <ul><li>create categories</li><li>edit only own categories</li><li>upload images only to own categories</li></ul>');
...
\define('_AM_WGSLIDER_PERMS_CATEGORY_VIEW', 'Permission to view this category');
\define('_AM_WGSLIDER_PERMS_CATEGORY_VIEW_DESC', 'Groups which should have permission to view this category');
